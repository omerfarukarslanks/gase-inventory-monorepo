          ...
          <div className="space-y-3 p-3">
            {loading ? (
              ...
              customers.map((customer) => {
                const isToggling = togglingCustomerIds.includes(customer.id);

                return (
                  <article key={customer.id} className="space-y-4 rounded-xl2 border border-border bg-surface p-4">
                    ...
                    <dl className="grid gap-3 text-sm text-text2">
                      <div>
                        ...
                        <dd className="mt-1">{customer.phoneNumber ?? "-"}</dd>
                      </div>
                      <div>
                        <dt className="text-[11px] font-semibold uppercase tracking-wide text-muted">E-Posta</dt>
